...
def csv2pq(path_in: str, bucket_out: str) -> None:
    ...
    try:
        ...
        # Read the CSV from S3, and partition by year, month, and day extracted
        ...
        con.execute(f"""
            ...
            ) TO "s3://{bucket_out}/year={{year}}/month={{month}}/day={{day}}/part.parquet"
            (FORMAT 'parquet');
        """)

        logging.info(
            f"Parquet written to s3://{bucket_out}/year=.../month=.../day=...")
